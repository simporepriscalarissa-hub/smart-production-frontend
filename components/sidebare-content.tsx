...
import {
  ...
  Building2, BarChart3, Tv, Settings, LogOut,
} from "lucide-react"
...
const menuAdmin = [
  ...
  { label: "Configuration Ecran TV", href: "/dashboard/ecran-tv", icon: Tv },
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <ScrollArea className="flex-1 p-4">
        <p className="text-xs text-zinc-500 mb-3 uppercase tracking-wider">Menu</p>
